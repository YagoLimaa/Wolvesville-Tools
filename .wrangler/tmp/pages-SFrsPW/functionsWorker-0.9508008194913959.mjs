...
// ../.wrangler/tmp/bundle-g4WqPf/checked-fetch.js
...
// api/middleware/requestConfig.js
...
async function handleRoleRotations(request) {
  ...
  const extractRoles = /* @__PURE__ */ __name((data) => {
    if (!data) return [];
  ...
  const formattedRotations = rotationsFromApi.map((rotationData) => {
    ...
    if (gameMode === "sandbox" && Array.isArray(rotationData.roleRotations)) {
      const processRole = /* @__PURE__ */ __name((roleData) => {
        let roleId;
        let probability;
...
// api/routes/proxy.js
var handleProxy = /* @__PURE__ */ __name(async (request) => {
  const { searchParams } = new URL(request.url);
...
var router = {
  get: /* @__PURE__ */ __name((path, handler) => addRoute("GET", path, handler), "get"),
  post: /* @__PURE__ */ __name((path, handler) => addRoute("POST", path, handler), "post"),
  all: /* @__PURE__ */ __name((path, handler) => addRoute("ALL", path, handler), "all")
};
...
// ../.wrangler/tmp/pages-SFrsPW/functionsRoutes-0.36884938288034097.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../../../Users/yagoo/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../Users/yagoo/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-g4WqPf/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-g4WqPf/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9508008194913959.mjs.map
